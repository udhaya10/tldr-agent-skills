...
description: "[DEPRECATED — replaced by tldr-audit-coverage] This skill was retired in the 14-skill intent-aligned restructure. DO NOT activate — see body for migration commands."
allowed-tools: [Bash]
metadata:
  deprecated: "true"
  replaced-by: "tldr-audit-coverage"
  deprecation-date: "2026-05-22"
  scheduled-removal: "next minor release"
---

# tldr-formal-methods — DEPRECATED
...
- `tldr-audit-coverage` — contracts / invariants / specs / verify (formal contracts + test coverage in one skill)

## To migrate

```bash
npx skills remove tldr-formal-methods
