...
This skill provides raw numerical outputs suitable for management dashboards or CI gating.
...
### 1. `tldr loc`
Calculate physical and logical Lines of Code.
* **Usage:** `tldr loc <dir>`
* **Advanced Flags:**
...
* **Note:** This tool does NOT run tests. It only parses existing coverage reports.
