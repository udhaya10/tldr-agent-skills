...
description: "[DEPRECATED — replaced by tldr-architecture, tldr-audit-api] This skill was retired in the 14-skill intent-aligned restructure. DO NOT activate — see body for migration commands."
allowed-tools: [Bash]
metadata:
  deprecated: "true"
  replaced-by: "tldr-architecture, tldr-audit-api"
  deprecation-date: "2026-05-22"
  scheduled-removal: "next minor release"
---

# tldr-refactor-oo — DEPRECATED
...
- `tldr-architecture` — coupling (function-call coupling between modules)
- `tldr-audit-api` — inheritance (class hierarchy analysis)

## To migrate

```bash
npx skills remove tldr-refactor-oo
