...
description: "[DEPRECATED — replaced by tldr-audit-security] This skill was retired in the 14-skill intent-aligned restructure. DO NOT activate — see body for migration commands."
allowed-tools: [Bash]
metadata:
  deprecated: "true"
  replaced-by: "tldr-audit-security"
  deprecation-date: "2026-05-22"
  scheduled-removal: "next minor release"
---

# tldr-security-taint — DEPRECATED
...
- `tldr-audit-security` — taint / secure / vuln (same tool plus its security siblings in one place)

## To migrate

```bash
npx skills remove tldr-security-taint
