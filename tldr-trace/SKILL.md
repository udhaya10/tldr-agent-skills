---
name: tldr-trace
description: "[DEPRECATED — replaced by tldr-trace-relationships, tldr-change-impact] This skill was retired in the 14-skill intent-aligned restructure. DO NOT activate — see body for migration commands."
allowed-tools: [Bash]
metadata:
  deprecated: "true"
  replaced-by: "tldr-trace-relationships, tldr-change-impact"
  deprecation-date: "2026-05-22"
  scheduled-removal: "next minor release"
---

# tldr-trace — DEPRECATED
...
- `tldr-trace-relationships` — calls / references / impact / dead (function-level relationships)
- `tldr-change-impact` — when starting from a git change rather than a function name (impact / whatbreaks / diff)

## To migrate

```bash
npx skills remove tldr-trace
